            ...
            <div key={id} className="break-inside-avoid mb-4">
                ...
                >
                    ...
                    <div className="bg-gradient-to-b from-[#e2985f] via-[#f3be6d] to-[#e2985f] p-3 mt-2 border-2 border-[rgba(92,64,51,0.2)]">
                        <h3 className="font-neodgm font-bold text-shadow text-sm mb-2 text-[#5c2500] tracking-wider">
                            {title}
                        </h3>
                        {description && (
                            <p className="font-neodgm font-light text-shadow text-xs text-[#8b6f47] leading-relaxed whitespace-pre-wrap break-words line-clamp-[10]">
                                {description}
                            </p>
                        )}
                    </div>
