        ...
        >
            <div className="relative max-w-[45vw] max-h-[90vh]">
                ...
                <img
                    src={src}
                    alt={alt}
                    className="max-w-[45vw] max-h-[50vh] object-contain rounded-sm shadow-2xl"
            ...
            <div className="relative mt-4 max-w-[45vw]">
                ...
                <div className="bg-gradient-to-b from-[#e2985f] via-[#f3be6d] to-[#e2985f] p-3 border-2 border-[rgba(92,64,51,0.2)]">
                    <h3 className="font-neodgm font-bold text-shadow text-base mb-2 text-[#5c2500] tracking-wider">
                        {title}
                    </h3>
                    {description && (
                        <p className="font-neodgm font-light text-shadow text-sm text-[#8b6f47] leading-relaxed whitespace-pre-wrap break-words overflow-y-auto max-h-32">
                            {description}
                        </p>
                    )}
                </div>
